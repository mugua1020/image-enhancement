...
if __name__ == "__main__":
    Image1_path = "Lenna_gray.png"
    Image2_path = ["Lenna_gray_cycle_gaussian.png","result_mean.png", "result_median.png", "result_gauss.png", "result_LF.png", "result_Notch.png"]
    for i in range(len(Image2_path)):
        print_result(Image1_path, Image2_path[i])
